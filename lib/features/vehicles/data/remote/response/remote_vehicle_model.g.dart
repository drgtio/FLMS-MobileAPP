...
RemoteVehicleModel _$RemoteVehicleModelFromJson(Map<String, dynamic> json) =>
    RemoteVehicleModel(
      ...
      currentAssignmentStartDate: json['currentAssignmentStart'] as String?,
      currentAssignmentEndDate: json['currentAssignmentEnd'] as String?,
      currentAssignmentComment: json['assignmentComment'] as String?,
...
Map<String, dynamic> _$RemoteVehicleModelToJson(RemoteVehicleModel instance) =>
    <String, dynamic>{
      ...
      'currentAssignmentStart': instance.currentAssignmentStartDate,
      'currentAssignmentEnd': instance.currentAssignmentEndDate,
      'assignmentComment': instance.currentAssignmentComment,
